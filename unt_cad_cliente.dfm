object frm_cad_cliente: Tfrm_cad_cliente
  ...
  object lbl_renda: TLabel
    Left = 622
    Top = 155
    Width = 54
    Height = 23
    Caption = 'Renda'
    FocusControl = dbe_renda
  end
  ...
  object dtp_cli: TDateTimePicker
    Left = 8
    Top = 184
    Width = 209
    Height = 31
    Date = 44427.000000000000000000
    Time = 0.588455648146919000
    TabOrder = 11
    OnChange = dtp_cliChange
  end
  ...
  object btn_pesq_cliente: TBitBtn
    Left = 652
    Top = 8
    Width = 120
    Height = 65
    ...
    NumGlyphs = 2
    TabOrder = 13
    OnClick = btn_pesq_clienteClick
  end
  object ds_cad_cli: TDataSource
    AutoEdit = False
    DataSet = DM.qry_cad_cliente
    OnStateChange = ds_cad_cliStateChange
    OnDataChange = ds_cad_cliDataChange
    Left = 464
    Top = 16
  end
end
